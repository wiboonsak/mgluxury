 <?php  if(!isset($currentID)){ $currentID='';}
		...
		if(!isset($news_date_end)){ $news_date_end =date("d-m-Y");}
						...
						<form enctype="multipart/form-data" id="productForm" name="productForm">
						 ...
						 <div class="form-group row">
							  <label class="col-sm-2 col-form-label">News Details</label>
								<div class="col-sm-6">
									<textarea id="news_detail" name="news_detail" class="summernote" ><?php echo $news_detail?></textarea>
								</div>
							   <div class="col-sm-4">	</div>
						</div>
							 ...
							 <div class="form-group row">
							  <label class="col-sm-2 col-form-label">Date Start</label>
								<div class="col-sm-6">
									<input   type="date" id="news_date_add" name="news_date_add" value="<?php if($currentID!=''){echo $news_date_add;}else{echo $datetoday;}?>" class="form-control form-control-sm"/> 
								</div>
							   <div class="col-sm-4">	</div>
						</div>	
<!--							 <div class="form-group row">
