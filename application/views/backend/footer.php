   ...
   <div id="modal_Large" class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none;">
       ...
       <div id="modal_Large2" class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog modal-lg">
       ...
       <div id="myModal1" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
					<h4 class="modal-title titleA" id="myModalLabel1">Modal Heading</h4>
				</div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 text-center" >
                        ...
                        @2019.CMS | Developed by me-fi.com
<!--                        <img src="<?php echo base_url('HTML/images/footer.jpg')?>" alt="" height="50" class="logo-small">-->
                    </div>
                </div>
            </div>
        </footer>
...
<script>
			function cangePassForm(){
				$.post('<?php echo base_url('control/cangePassForm')?>' , { }, function(data){
						...
						$('#myModalLabel1').text('Change Password');
						$('.bodyA').html(data);
						$('#myModal1').modal('show');	
				})
			}
			...
			function DoChangePass(){
				...
				if(newpass==''){
					...
					$('#ShowError').html('<span class="text-danger">Password and password confirmation must match</span>');
					return false;	
				}else{
					$('#ShowError').empty();
					$.post('<?php echo base_url('control/doChangePass')?>', { newpass : newpass, id : id  }, function(data){
						if(data==1){
							alert('The password has been changed.');
							$('#myModal1').modal('hide');	
						}else{
							$('#ShowError').html('<span class="text-danger">Error Cannot change password.</span>');
						}
					})
				}
			}
