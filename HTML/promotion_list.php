        ...
        <div class="wrapper">
            ...
            <div class="widget kopa-tag-line-widget style1" style="background: url(images/bg_promotion.jpg) !important">
                ...
                <div class="widget-content">
                    <a href="#">
						<h2 class="tag-heading" style="margin: 0px !important">PROMOTIONS</h2>
            ...
            <div class="row">
				 		<div class="widget-area-3 col-md-4 col-sm-6 col-xs-6">
                            ...
                            <div class="widget kopa-article-list-widget article-list-2">
                                <h3 class="widget-title style1">PROMOTION</h3>
                                <ul class="clearfix">
                                    <li>
                                        <article class="entry-item">
                                            <div class="entry-thumb">
                                                <a href="promotion_detail.php"><img src="images/promotion_2.jpg" alt=""></a>
                                            </div>
                                            <div class="entry-content">
                                                <div class="content-top">
                                                    <h4 class="entry-title"><a href="promotion_detail.php">MG FRIEND GETS FRIEND แนะนำเพื่อนซื้อ MG EXTENDER วันนี้รับค่าแนะนำ 10,000 บาท</a></h4>
                            ...
                            <div class="widget kopa-article-list-widget article-list-2">
                                ...
                                <ul class="clearfix">
                                    <li>
                                        <article class="entry-item">
                                            <div class="entry-thumb">
                                                <a href="promotion_detail.php"><img src="images/promotion_1.jpg" alt=""></a>
                                            </div>
                                            <div class="entry-content">
                                                <div class="content-top">
                                                    <h4 class="entry-title"><a href="promotion_detail.php">MG FRIEND GETS FRIEND แนะนำเพื่อนซื้อ MG EXTENDER วันนี้รับค่าแนะนำ 10,000 บาท</a></h4>
