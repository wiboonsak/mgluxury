        ...
        <div class="wrapper">
            ...
            <div class="widget kopa-tag-line-widget style1" style="background: url(images/bg_promotion.jpg) !important">
                ...
                <div class="widget-content">
                    <a href="#">
						<h2 class="tag-heading" style="margin: 0px !important">NEWS</h2>
                            ...
                            <ul class="clearfix">                               
                                <li>
                                    <article class="entry-item">
                                        <div class="entry-thumb" style="width: auto">
                                            <a href="#"><img src="images/news_1.jpg" alt=""></a>
                                        </div>
                                        <div class="entry-content">
                                            <div class="content-top">
                                                <h4 class="entry-title"><a href="news_detail.php">เอ็มจี เผยยอดการผลิต NEW MG ZS ทะลุ 30,000 คัน หลังยอดขายทะยานต่อเนื่อง พร้อมเดินหน้ารุกตลาดส่งออก</a></h4>
                                                <p class="entry-comment"><a href="#">08 Feb 2020</a></p>
                                            </div>
                                            <p>กรุงเทพฯ – 23 มกราคม 2563 - บริษัท เอสเอไอซี มอเตอร์ – ซีพี จำกัด และ บริษัท เอ็มจี เซลส์ (ประเทศไทย) จำกัด ผู้ผลิตและผู้จำหน่ายรถยนต์เอ็มจีในประเทศไทย ฉลองความสำเร็จของรถยนต์ SUV ยอดนิยมจากเอ็มจี NEW MG ZS ที่มียอดการผลิตสะสม</p> 
                                            <footer>
